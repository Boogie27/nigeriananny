...
if(!Admin_auth::is_loggedin())
{
  ...
  Session::put('old_url', '/admin-course/category');
                            ...
                            <table class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="ui_kit_whitchbox">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox"  data-id="<?= $category->category_id  ?>" class="custom-control-input categories_feature_btn" id="customSwitch_<?= $category->category_id  ?>" <?= $category->is_categoryFeature ? 'checked' : '';?>>
                                        ...
                                        <td>
                                            <a href="#" data-toggle="modal" data-target="#exampleModal_category_edit" id="<?= $category->category_id  ?>" data-category="<?= $category->category_name ?>" class="edit_category_btn" title="Edit category"><i class="fa fa-edit"></i></a>
                                           <span class="expand"></span>
                                           <a href="#"  data-toggle="modal" id="<?= $category->category_id  ?>" data-target="#exampleModal_category_delete" class="delete_category_btn" title="Delete category"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="login_form">
                        <form action="#">
                            ...
                            <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="submit_category_add_btn" class="btn btn-fill btn-log btn-block">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="login_form">
                        <form action="#">
                            ...
                            <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="submit_category_edit_btn" class="btn btn-fill btn-log btn-block">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="login_form">
                        <form action="#">
                            ...
                            <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="submit_category_delete_btn" class="btn bg-danger btn-log btn-block" style="color: #fff;">Delete</button>
                        </form>
                    </div>
                </div>
            </div>
...
$("#submit_category_delete_btn").click(function(e){
    ...
    $("#submit_category_delete_btn").html("Please wait...")
    ...
    $.ajax({
		...
		success: function(response){
            ...
            $("#submit_category_delete_btn").html("Delete")
		}
	});
});
...
function edit_category(){
    ...
    if(category == ''){
        ...
        $(".top_alert_modal").html('*Category field is required');
        return;
    }else if(category.length > 50){
        $(".top_alert_modal").show()
        $(".top_alert_modal").html('*Category must be maximum of 50 characters');
        return;
    }

    $("#submit_category_edit_btn").html('please wait...')
    ...
    $.ajax({
		...
		success: function(response){
            ...
            $("#submit_category_edit_btn").html('Submit')
		},
        error: function(){
            $('.page_alert_danger').show();
            $("#submit_category_edit_btn").html('Submit')
...
function add_category(){
    ...
    $("#submit_category_add_btn").html('Please wait...')
    ...
    $.ajax({
		...
		success: function(response){
            ...
            $("#submit_category_add_btn").html('Submit')
		},
        error: function(){
            $('.page_alert_danger').show();
            $("#submit_category_add_btn").html('Submit')
