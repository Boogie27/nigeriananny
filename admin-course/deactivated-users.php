...
if(!Admin_auth::is_loggedin())
{
  ...
  Session::put('old_url', '/admin-course/deactivated-users');
...
// GET ALL EMPLOYEES
// ===========================================
$users = $connection->select('course_users')->where('is_deactivate', 1);
                ...
                <div class="row">
                    ...
                    <div class="alert alert-danger text-center p-3 mb-2 page_alert_danger" style="display: none;"></div>
                        ...
                        <div class="text">
                            ...
                            <a href="#" class="text-primary" id="open_mass_users_activate_modal_btn"> Activate |</a>
                        </div>
                    </div>
                    <div class="col-lg-12">
                            ...
                            <table class="table table-striped" id="members_parent_table_container">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                           <a href="#" data-id="<?= $user->id ?>" data-toggle="modal"  data-target="#exampleModal_deactivate_user_delete" class="course_user_deactivate_btn delivered">Activate</a>
                                        </td>
