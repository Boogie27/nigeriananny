            ...
            <div class="sub-inner-content">
                ...
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="send_members_newsletter_confirm_submit_btn" class="btn btn-block btn-primary">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                ...
                <div class="confirm-header">
                    <p>Do you wish to activate these users?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="members_activate_confirm_submit_btn" class="btn btn-block btn-primary">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                ...
                <div class="confirm-header">
                    <p>Do you wish to deactivate these users?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-course/ajax.php') ?>" id="members_deactivate_confirm_submit_btn" class="btn btn-block btn-danger">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
