...
<link rel="stylesheet" href="<?= asset('/admin-course/css/dashbord_navitaion.css') ?>">
<!-- Responsive stylesheet -->
<link rel="stylesheet" href="<?= asset('/admin-course/css/responsive.css') ?>">

<!-- main style -->
<link rel="stylesheet" href="<?= asset('/admin-course/css/main-style.css') ?>">
