...
// ======================================
$requests = $connection->select('request_workers')->leftJoin('employers', 'request_workers.j_employer_id', '=', 'employers.id')->where('is_accept', 1)->where('is_employee_delete', 0)->where('j_employee_id', Auth_employee::employee('id'))->get();
            ...
            <div class="row">
                ...
                <div class="col-lg-9"><!-- content start-->
                    ...
                    <?php if(count($requests)): ?>
                        <h3 class="rh-head">Accepted job offers</h3><br><br>
                    <?php endif; ?>
                        <?php if(count($requests)): 
