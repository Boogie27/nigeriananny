                            ...
                            <div class="account-x">
                                ...
                                <div class="account-x-body">
                                    <ul class="ul-account-bar">
                                        ...
                                        <li>Profile image <i id="check_image" class="fa fa-check <?= $employee->w_image ? 'text-warning' : 'text-danger'?>"></i></li>
                                        <li>Expected salary <i id="check_salary" class="fa fa-check <?= $worker->amount_form ? 'text-warning' : 'text-danger'?>"></i></li>
                                    </ul>
                                </div>
                            </div>
                        </div><!-- right nav end-->
                              ...
                              <div class="account-h">
                                <div class="inner-content-x">
                                   ...
                                   <ul>
                                       ...
                                       <li class="text-right"><a href="<?= url('/employee/update.php?page=about') ?>" class="text-primary">Add</a></li>
                                   </ul>
                                    <?php else: ?>
                                   <div class="inner-body">
                                        <p class="inner-p"><?= ucfirst($worker->bio) ?></p>
                                       <ul>
                                           <li class="text-right"><a href="<?= url('/employee/update.php?page=about') ?>" class="text-primary">Update</a></li>
                                       </ul>
                                   </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="account-h">
                                <div class="inner-content-x">
                                   ...
                                   <ul>
                                       ...
                                       <li class="text-right"><a href="<?= url('/employee/update.php?page=work') ?>" class="text-primary">Add</a></li>
                                   </ul> 
                                    <?php else: ?>
                                   <div class="inner-body">
                                       ...
                                       <ul class="inner_ul">
                                            ...
                                            <li><p class="inner-p"><b>Description:</b><br> <?= $experience['description'] ?></p></li>
                                            <li>
                                                <div class="row">
        ...
        success: function (response){
           var data = JSON.parse(response);
            if(data.error){
                ...
                img_preloader() //remove profile image preloader
