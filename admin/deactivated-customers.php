...
if(!Admin_auth::is_loggedin())
{
    ...
    Session::put('old_url', '/admin/deactivated-customers');
  return Redirect::to('login.php');
}


$customers = $connection->select('users')->where('is_deactivate', 1);
            ...
            <div class="main_content_container">
                <div class="row">
                    ...
                    <div class="alert-danger text-center p-3 mb-2 category_alert_danger" style="display: none;"></div>
                        ...
                        <div class="text">
                            Total Deactivated: <?= count($customers->result())?>
