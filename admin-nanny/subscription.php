...
// GET ALL EMPLOYEES
// ===========================================
$employers = $connection->select('employer_subscriptions')->leftJoin('employers', 'employer_subscriptions.s_employer_id', '=', 'employers.id');

if($search = Input::get('search'))
{
    if(preg_match('/@/', $search))
    {
        $employers->where('employers.email', $search);
    }else{
        $employers->where('employers.first_name', 'RLIKE', $search);
    }
}
