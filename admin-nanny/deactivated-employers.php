...
if(!Admin_auth::is_loggedin())
{
  ...
  Session::put('old_url', '/admin-nanny/deactivated-employers');
...
// ===========================================
$employers = $connection->select('employers')->where('e_deactivate', 1);
                ...
                <div class="row">
                    ...
                    <div class="alert alert-danger text-center p-3 mb-2 page_alert_danger" style="display: none;"></div>
                        <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                            <h4 class="title float-left">Deactivated employers</h4>
                        ...
                        <div class="text">
                            ...
                            <a href="#" class="text-primary" id="open_mass_member_activate_modal_btn"> Activate |</a>
                        </div>
                    </div>
                    <div class="col-lg-12">
