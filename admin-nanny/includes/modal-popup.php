            ...
            <div class="sub-inner-content">
                ...
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-nanny/ajax.php') ?>" id="send_members_newsletter_confirm_submit_btn" class="btn btn-block btn-primary">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
...
<!--  SEND MODAL ALERT START -->
<section class="modal-alert-popup" id="member_approve_confirm_modal_popup_box">
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                <div class="text-right p-2">
                ...
                <div class="confirm-header">
                    <p>Do you wish to approve this members?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-nanny/ajax.php') ?>" id="members_approve_confirm_submit_btn" class="btn btn-block btn-primary">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                ...
                <div class="confirm-header">
                    <p>Do you wish to activate this members?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-nanny/ajax.php') ?>" id="members_activate_confirm_submit_btn" class="btn btn-block btn-primary">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="sub-confirm-container">
        <div class="sub-confirm-dark-theme">
            <div class="sub-inner-content">
                ...
                <div class="confirm-header">
                    <p>Do you wish to deactivate this members?</p>
                </div>
                <div class="confirm-form">
                    <form action="" method="POST" class="p-2">
                        <button type="button" data-url="<?= url('/admin-nanny/ajax.php') ?>" id="members_deactivate_confirm_submit_btn" class="btn btn-block btn-danger">Proceed</button>
                    </form>
                </div>
            </div>
        </div>
