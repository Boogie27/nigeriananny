...
// *********** OPEN APPROVE MEMBERS MODAL *************//
$("#open_mass_member_approve_modal_btn").click(function(e){
    e.preventDefault()
    if(stored_id.length == 0)
    {
        return bottom_alert_error('No member was selected!')
    }
    $("#member_approve_confirm_modal_popup_box").show()
})
...
// ******** APPROVE MEMBERS *************//
$("#members_approve_confirm_submit_btn").click(function(e){
    e.preventDefault()
...
$("#open_mass_member_activate_modal_btn").click(function(e){
    e.preventDefault()
    if(stored_id.length == 0)
    {
        return bottom_alert_error('No member was selected!')
