...
if(!Admin_auth::is_loggedin())
{
  ...
  Session::put('old_url', '/admin-nanny/unapproved-employees');
...
// GET ALL EMPLOYEES
// ===========================================
$employees = $connection->select('employee')->where('e_approved', 0);
                ...
                <div class="row">
                    ...
                    <div class="alert alert-danger text-center p-3 mb-2 page_alert_danger" style="display: none;"></div>
                        <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                            <h4 class="title float-left">Unapproved employees</h4>
