...
// ======================================
$requests = $connection->select('request_workers')->leftJoin('employee', 'request_workers.j_employee_id', '=', 'employee.e_id')->where('is_accept', 0)->where('is_cancle', 0)->where('j_employer_id', Auth_employer::employer('id'))->get();
                    ...
                    <div class="account-x accepted-x-body">
                        ...
                        ?>
                            <div class="jobs-info accept-x-inner">
                                ...
                                <ul class="ul">
                                    <li>
                                        <h4><a href="<?= url('/job-detail.php?wid='.$request->r_worker_id) ?>"><?= ucfirst($detail['job_title'])?></a> </h4>
