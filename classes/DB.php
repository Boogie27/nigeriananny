                    ...
                    foreach($columns as $val)
                    {
                        switch($columns[0])
                        {
                            case 'min':
                                ...
                                {
                                    $this->_validate_error[$key] = '*'.$field_name.' must be minimum of '.$columns[1].' characters';
                                }
                            break;
                            ...
                            case 'max':
                                if(!empty($_POST[$key]) && strlen($_POST[$key]) > $columns[1])
                                {
                                    $this->_validate_error[$key] = '*'.$field_name.' must be maximum of '.$columns[1].' characters';
                                }
                            break;
